...
pubsui.ready = function ()
{
        ...
        r = null; r = {
            ...
            alpPermissions: function () {
                $(t.ctrl).on("click", t.clickTrigger, function (n) {
                    ...
                    var r, i; n.which === 27 && ($(this).removeClass("open"),
                    ...
                    log.add("keydown", "", n.target.className, t.ctrl, "Keypress: " + n.which + "\n\tValue: " + r + "");
    ...
    var getCookie = function (n) {
        ...
        var t = parseInt(n); t < 0 && (t = 0); t !== null && t !== undefined && t > 0 ? ($(".badge--count").show(), $(".badge--count").html(n)) : $(".badge--count").hide()
            ...
            var n = getCookie("BasketCookieGuid"); userDetails = getCookie("ud");
            n && $.ajax({
    ...
    var n = !1, t = document.querySelectorAll(".nav-item-first")[0],
        i = document.querySelectorAll(".nav-item-last")[0]; document.addEventListener("keydown", function (t) {
            t.keyCode == 16 && (n = !0)
        }, !1); document.addEventListener("keyup", function (t) { t.keyCode == 16 && (n = !1) }, !1);
    i.addEventListener("keydown", function (i) {
        i.keyCode != 9 || n || (t.focus(),
            i.preventDefault())
    }, !1); t.addEventListener("keydown", function (t) {
        t.keyCode == 9 && n && (i.focus(),
            t.preventDefault())
    }, !1); document.querySelectorAll(".pubs-nav-drawer")[0].addEventListener("keyup", function (n) {
        n.keyCode == 27 && t.click()
    }, !1); document.getElementById("mobileSearchTrigger").addEventListener("click", function (n) {
        const i = Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0); if (i < 730) {
            n.preventDefault(); var t = document.getElementById("mobileSearchPanel");
            t.classList.contains("open") ? (t.classList.remove("open"),
                document.getElementById("mobileSearchTrigger").focus()) : (t.classList.add("open"),
                    document.getElementById("SearchTextMobile").focus()); n.preventDefault()
        }
    }, !1); document.getElementById("mobileSearchPanel").addEventListener("keyup", function (n) {
        n.keyCode == 27 && (document.getElementById("mobileSearchPanel").classList.remove("open"),
            document.getElementById("mobileSearchTrigger").focus())
    }, !1);
    let u = document.getElementById("btnHamburgerMainNav");
    $('document').ready(function () {
        $("#lastLinkOnPage").keydown(function (n) {
            n.keyCode == 9 && (u.focus(), n.preventDefault())
        })
    })
