        ...
        <div class="row">
             <form class="form-group" name="frmImage" enctype="multipart/form-data"method="post" autocomplete="off">
                ...
                <select name="categorieid" id="categorieid" class="form-control">
                    ...
                    <option <?=($key['categoriesid'] ==34) ? 'selected' : ''?> value="<?=$key['categoriesid']?>"><?=$key['categories_name']?></option>
                    <?php endforeach;?>
                </select><br/><br/>
                ...
                <select name="bookshelvesid" id="bookshelvesid" class="form-control">   
                    ...
                    <option  <?=((($key['bookshelvesid'] ==240))?'selected':'')?> value="<?=$key['bookshelvesid']?>"><?=$key['bookshelves_name']?></option>
                    <?php endforeach;?>
                </select><br/><br/>
